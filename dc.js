...
let catalogoDc = document.querySelector("#catalogoDc")
...
function cargarDc(){
    let editorialValorDc= 'DC comics';
    let comicsDc=[]
    for(i=0;i<comics.length;i++) {
       if(comics[i].editorial.includes(editorialValorDc))
       comicsDc.push(comics[i])
    }
    cargarCatalogo(comicsDc)
}
