...
let catalogoMarvel = document.querySelector("#catalogoMarvel")
...
function cargarMarvel(){
    let editorialValor= 'Marvel';
    let comicsMarvel=[]
    for(i=0;i<comics.length;i++) {
       if(comics[i].editorial.includes(editorialValor))
       comicsMarvel.push(comics[i])
    }
    cargarCatalogo(comicsMarvel)
}
